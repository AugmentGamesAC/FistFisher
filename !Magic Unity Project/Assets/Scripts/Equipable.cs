...
public class Equipable : Interactable
{
	...
	public override void OnInteractBegin(Hand hand)
	{
		// Already held check
		if (m_ActiveHand) return;
	...
	public override void OnInteractEnd(Hand hand)
	{

	}

	public override void OnInteractGripBegin(Hand hand)
	{
	...
	public override void OnInteractGripEnd(Hand hand)
	{
