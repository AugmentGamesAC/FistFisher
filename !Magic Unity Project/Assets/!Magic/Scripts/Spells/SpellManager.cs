...
{
    /// <summary>
    /// things for spells and spell instances based on 
    /// </summary>
    public class SpellBehaviours
    {
        [System.Serializable]
    ...
    [SerializeField]
    private static SpellBehaviours m_SpellBehaviour;
    ...
    public static SpellBehaviours SpellBehaviour
    {
        get
        {
            if (m_SpellBehaviour == null)
                m_SpellBehaviour = new SpellBehaviours();
